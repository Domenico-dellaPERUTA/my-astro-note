// src/soap/templates/responses.ts
...
export function createSayHelloResponse(message: string): string {
  const responseBody = `<sayHelloResponse xmlns="http://example.com/hello">
